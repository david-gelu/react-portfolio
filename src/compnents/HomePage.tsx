    ...
    <main className="main" id="main">
      ...
      <div className="d-flex flex-column obj-info">
        ...
        <div>
          ...
          <div><span className="ms-3 key">"type"</span> : <span className="property">"Open-source"</span></div>
        ...
        <div>
          ...
          <span className="ms-3 property">"css"</span>,
          <span className="ms-3 property"> "js"</span>
          <span>&#x5d;,</span>
        </div>
        <div>
        ...
        <div>
          ...
          <div><span className="ms-3 key">"music"</span> : <span className="property">t-series :D,</span></div>
